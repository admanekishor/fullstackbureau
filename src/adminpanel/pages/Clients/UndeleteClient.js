...
const UndeleteClient = ({ clientUpdate, getClientdata, afterclose }) => {
  ...
  const submitData = (e) => {
    ...
    if (!clientVisitor.error && !empService.error) {
      ...
      axios.post('http://www.muktainursesbureau.in/API/undeleteclient.php', empData).then((res) => {
