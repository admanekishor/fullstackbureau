...
let Footer = () => {
    return (
        <div className={bureu.footer}>
            <ScrollTop>
                <Container fluid>
                    <Row>
                        <Col xs={12} md={3}>
                            <div>
                                <h4 className={bureu.heading_white}>Muktai Nurses Bureu</h4>
                            ...
                            <p className={bureu.textJustify}>CareGiver is a WordPress theme to build Elderly People Care. It has good features and you will love.</p>
                        </Col>
                        <Col xs={12} md={6}>
                            <h4>Quick Links</h4>
                            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-evenly' }}>
                                <div>
                                    <ul className={bureu.quickList}>
                                        <li>
                        ...
                        <Col xs={12} md={3}>
                            ...
                            <div>
                                ...
                                <ul className={bureu.quickList} style={{ textAlign: 'center' }}>
                    ...
                    <hr />
                    <Row>
                        <Col><span>© 2021 All Rights Reserved. Design By admanekishor404@gmail.com</span></Col>
                    </Row>
                </Container>
            </ScrollTop>
        </div>
